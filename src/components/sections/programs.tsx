...
const programs = [
  {
    ...
    points: ['150 базовых иероглифов', 'Уверенное произношение и тоны', 'Бытовые диалоги и фразы', 'Чтение пиньинь без словаря'],
    featured: false,
  },
  {
    tag: '进阶',
  ...
  },
  {
    ...
    level: 'Продвинутый',
    hsk: 'HSK 5–6',
    duration: '8 месяцев · 2–3 раза в неделю',
